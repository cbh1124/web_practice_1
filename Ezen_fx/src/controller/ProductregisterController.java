...
public class ProductregisterController {
	 ...
	 void register(ActionEvent event) {
		...
		if(result) {
			alert.setHeaderText("제품 등록 성공 "); alert.showAndWait();  // 메시지팡 띄우기 
