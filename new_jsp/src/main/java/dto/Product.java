...
public class Product {
	    ...
	    public String getprice() {
	    	DecimalFormat decimalFormat = new DecimalFormat("###, ###"); // DecimalFormat : 숫자 형식
		...
		public Product(String p_name, int p_price, String p_category, String p_manufacturer, int p_active,
				String p_size, int p_stock, String p_img, String p_contents) {
