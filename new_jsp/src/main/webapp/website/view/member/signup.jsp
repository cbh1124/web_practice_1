	...
	<div class = "container"> <!-- 박스권 :  -->
		<div class = "row"> <!-- 가로 박스 -->
			<div class = "col-md-6"> <!-- 6:6 -->
				<img src="/new_jsp/website/view/img/apple.jpg " alt=""  width = 100%; >
			</div>
			...
			<div class = "col-md-6"> <!-- 6:6 -->
				<form id = "signupform"action = "../../controller/signupcontroller.jsp" method="post" onsubmit="return signupcheck()">
					<div class = "row">
						...
						<div class = "col-md-8"> <input id = "id" type="text" name = "id" onchange ="signupcheck();" class = "form-control" maxlength="15" ></div>
					</div>
					<div>
					...
					<div class = "row">
						...
						<div class = "col-md-8"> <input id = "birth" type="date" name = "birth" class = "form-control" onchange ="signupcheck();"></div>
					</div>
						<div>
					...
					<div class = "row">
						...
						<div class = "col-md-8 text-center"> 
							...
							<input id = "sex1" type="radio" name = "sex" value = "man" onchange ="signupcheck();">남
							<input id = "sex2" type="radio" name = "sex" value = "woman" onchange ="signupcheck();">여
