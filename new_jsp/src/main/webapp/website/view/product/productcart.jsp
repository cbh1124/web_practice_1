	...
	<div class="container">
		<table class="table">
			...
			<%
				...
				totalprice += cart.getP_count() * product.getP_price(); // 카트 내 제품 누적합계 [제품수량 * 제품가격]
		...
		<div>
			<button onclick="cartdelete('all' , '0' , '0')" class = "form-controll"> 모두 삭제</button>	
		</div>
		<div class = "text-center totalbox">
			<p> 총 상품 가격 <span class = "carttotal"><%=decimalFormat.format(totalprice)%></span> + 총 배송비 <span class = "carttotal">3000</span> = 총 주문금액 : <span class = "carttotal"><%=decimalFormat.format(totalprice+3000)%></span> </p>
		</div>
		
		<div class = "row">
			<div class = "col-md-3 offset-3">
				<a href="productpayment.jsp"><button class = "form-control bg-success text-white p-3"> 주문하기 </button></a>
			</div>
			<div class = "col-md-3">
