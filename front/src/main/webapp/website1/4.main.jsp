...
<title>Insert title here</title>
	...
	<style type="text/css">
		...
		li{list-style-type : none;} /*리스트 항목 굴머리 제거*/
		...
		#main_contents p{
			magin-top : 30px; line-height: 180%; /*줄간격*/
		}
		#figure{
...
<section id = "contents">			<!-- 섹션 태그 -->
	
		<nav  id = "sub_menu">			<!-- 메뉴 태그 [ div 사용해도 무관 ]-->
			<h3>사진이론</h3>
			<ul>
