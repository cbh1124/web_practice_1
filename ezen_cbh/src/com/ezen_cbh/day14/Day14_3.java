...
public class Day14_3 {
	public static void main(String[] args) {
		//  컬렉션 프레임 워크 
				// 컬렉션 :  수집 [자료구죠 : 데이터를 저장하는 방법]
				// 프레임워크 : 미리 만들어진 라이브러리를 사용방법 정의 
		...
		// p.728
		// 1. Arraylist : 배열과 유사 
			// 1. 가변길이 [ 기본 10 이지만 10이 넘으면 길이가 늘어남]
			...
			// 3. 메소드 
				...
				// 2. 리스트명.size() : 해당 인덱스의 객체 호출 
				// 3. 리스트명.get(인덱스) : 해당 인덱스의 객체 삭제 
				// 4. 리스트명.remove(인덱스) : 해당 인덱스 삭제
				// 5. 리스트명.contains(객체) : 해당 객체의 리스트내 존재 여부확인 [True/False]
				// 6. 리스트명.indexOf(객체) : 해당 객체의 리스트내 인덱스 번호
				// 7. 리스트명.clear() : 리스트 초기화 
				// 8. 리스트명.isEmpty() : 리스트가 비어 있는지 확인 [True/False]
		// 1. 리스트 생성 
		...
		for(String temp : list) {
			...
			System.out.println(" 어떻게 값이 나올까요");
