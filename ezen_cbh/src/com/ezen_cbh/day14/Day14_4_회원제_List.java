	...
	public static void main(String[] args) {
		...
		try {
			FileInputStream fileInputStream = 
				new FileInputStream("C:/Users/ez201207/git/web_practice_1/src/com/ezen_cbh/day14/test2.txt");
		...
		while(true) {
			...
			if( ch == 1 ) { // 회원 가입 s
				...
				System.out.println(" 성명 : ");		String name = sc.next();
					...
					// 4. 파일처리 
						...
						try {	
							FileOutputStream fileOutputStream = 
								new FileOutputStream("C:/Users/ez201207/git/web_practice_1/src/com/ezen_cbh/day14/test2.txt" , true );
			...
			// 2. 로그인
				...
				for( User temp : users ) {
					if( temp.getId().equals(id) && temp.getPassword().equals(password) ) {
						...
						///////////////////// 로그인 성공시//////////////////////////////
						while(true) {
							System.out.println("1. 회원정보 2. 회원수정 3. 탈퇴");
							int ch2 = sc.nextInt();
							...
							if(ch2 == 1) {
								...
								// 1. 수정할 정보 입력
								System.out.println("수정할 성명 : " ); String newname = sc.next();
								// 2. set 메소드를 통한 필드 값 변경 
								temp.setName(newname);
								// 파일업데이트 처리 
								try {	
									FileOutputStream fileOutputStream = 
										new FileOutputStream("C:/Users/ez201207/git/web_practice_1/src/com/ezen_cbh/day14/test2.txt"  );
							...
							else if(ch2 == 4) {System.out.println("-----로그 아웃-----"); break;}
						}
