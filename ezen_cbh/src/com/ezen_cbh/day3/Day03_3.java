...
public class Day03_3 {
	...
	// if( 논리제어 ) switch(데이터제어)
		...
		// 경우의 수가 정해져 있지 않는경우 => if[논리] 
			/* 형태 : switch( key : 검사대상 ) {
					...
					default : 실행문 ;
			*/
			// break : switch 혹은 반목문을 탈출 사용되는 키워드 { 가장 가까운 중괄호 탈출 }
	// 예 )
	public static void main(String[] args) {
		...
		switch( 점수 ) { //점수는 검사!!!
			// 점수가 90이면 
			case 90: System.out.println("A등급입니다."); break;
			// 점수가 80이면 
			case 80: System.out.println("B등급입니다."); break;
			// 점수가 70이면
			case 70: System.out.println("C등급입니다."); break;
			// 그외
		...
		// 문제 1 : [switch] 국어, 영어, 수학점수 입력받아 평균이 90점 이상이면 "A등급" 80점이상이면 "B" 나머지 탈락 
			Scanner sc = new Scanner(System.in);
			System.out.println("국어점수를 입력하시오 "); int 국어 = sc.nextInt();
			System.out.println("영어점수를 입력하시오 "); int 영어 = sc.nextInt();
			System.out.println("수학점수를 입력하시오 "); int 수학 = sc.nextInt();
