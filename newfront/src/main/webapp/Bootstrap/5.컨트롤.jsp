...
<body>
	...
	<div class="container"> 
		...
		<h3> 이미지 </h3>
			...
			<div class ="col-sm-6">
				<img src="강아지이미지_1.jpg">	
			</div>
			<div class ="col-sm-6">
				<img src="강아지이미지_1.jpg" class ="rounded ">
			</div>
			<div class ="col-sm-6">
				<img src="강아지이미지_1.jpg" class ="rounded-circle img-fluid">
			</div>
			<div class ="col-sm-6">
				<img src="강아지이미지_1.jpg" class ="img-thumbnail img-fluid">
			</div>
