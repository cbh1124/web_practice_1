...
<body>
	...
	<div class = "container"> <!-- 미리 만들어진 container -->
		<div class="row">
	...
	<h3>offset 위치 잡기 [col-md-offset-2 : 2칸 띄어쓰기 ]   </h3>
	<div class ="container">
		<div class = "row"> 
	...
	<div class = "container"> 
		<div class = "row">
			<div class = "col-md-5" > .col-md-5 </div>
			<div class = "col-md-8" > .col-md-8 </div> <!-- 아래로 내려감 이게 뭔소린지 모르겠다!!!!!!!!!!!!!!!!!!!!!!!!!!! 12그리드상태에서 13그리드를 요구하면 내려감??/  이해완료 진짜 내려가네-->
		</div>
		<div class = "row">
			<div class = "col-md-4" > .col-md-4 </div>
