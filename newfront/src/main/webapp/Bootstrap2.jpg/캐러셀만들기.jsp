		...
		<div id="carouselExampleFade" class="carousel slide carousel-fade" data-ride="carousel" data-interval="1000">
			...
			<div class = "carousel-inner">
				<div class="carousel-item active">
					<img class="d-block w-100" src="112233.jpg" alt="첫슬라이드">
				</div>
				<div class="carousel-item">
					<img class="d-block w-100" src="11223344.jpg" alt="둘째슬라이드">
				</div>
				<div class="carousel-item">
					<img class="d-block w-100" src="1122334455.jpg" alt="셋째슬라이드">
				</div>
			</div>
