...
<body>
	<!-- <footer class ="text-dark bg-light text-lg-start main-footer fixed-bottom bg-white"> 고정 할경우 하지만 안예뻐서 안함 -->
				...
				<div class = "col-md-3 mb-4"> <!-- 그리드 3 -->
					...
					<div class="col-md-3 mb-4"> <!-- 그리드 3 -->
						...
						<p>
							...
							지번: 부산시 금정구 장전동 400-31번지 4층ㄴㄴㄴ
							자세한 교환·반품절차 안내는 문의란 및 공지사항을 참고해주세요
						</p>
					</div>
					
					<div class="col-md-3 my-5"> <!-- 그리드 3 md mb m my 무슨차이..-->
